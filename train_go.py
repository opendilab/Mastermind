...
def prepare_dataset(tokenizer):
    test_data = load_dataset("go/task1", split='test')
    train_data = load_dataset("go/task1", split='train')

    test_data += load_dataset("go/task2", split='test')
    train_data += load_dataset("go/task2", split='train')

    test_data += load_dataset("go/task3", split='test')
    train_data += load_dataset("go/task3", split='train')
